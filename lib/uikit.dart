...
final class TutotialColors {
  ...
  static const secondaryColor1 = Color(0xFF40BB15);
  static const secondaryColor2 = Color(0xFF3C403D);
  static const textColor = Color(0xFF252B42);
  static const secondTextColor = Color(0xFF737373);
  static const lightTextColor = Color(0xFFFFFFFF);
  static const darkBackgroundColor = Color(0xFF252B42);
  static const lightBackgroundColor = Color(0xFFFFFFFF);
  static const hoverColor = Color(0xFF2A7CC7);
  static const disableElementColor = Color(0xFF8EC2F2);
  static const mutedColor = Color(0xFF8EC2F2);
  static const successColor = Color(0xFF8EC2F2);
  static const alertColor = Color(0xFFE77C40);
